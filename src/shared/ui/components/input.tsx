    ...
    return (
      <div className={cn(wrapperClassName)} >
        <input
          ...
          {...props}
        />
        {errors?.message && <div className="relative flex items-center gap-1 mb-4 text-red-500"><ErrorIcon /><span className={cn(errorClassName)}>{errors.message}</span></div>}
      </div>
    )
  }
)
