...
const ScheduleComponentModalAllRegister = ({
  formData,
  onChangeFormData,
}: Props) => {
  // 코치 목록
  ...
  const [, setScheduleList] = useState<Array<ScheduleListType>>([
    {
      id: 1,
      date: '',
      day: '',
  ...
  const getInputComponentByType = (type: string) => {
    if (type === 'lessonType')
      return (
        <LessonTypeInputRadioContainer onChangeFormData={onChangeFormData} />
      );
    if (type === 'lessonDateType')
      return (
        <LessonScheduleTypeInputRadioContainer
          onChangeFormData={onChangeFormData}
        />
      );
    if (type === 'lessonTime')
      return (
        <LessonTimeInputRadioContainer
          data={formData}
          onChangeFormData={onChangeFormData}
        />
      );
    if (type === 'lessonCount')
      return (
        <LessonCountOfWeekInputRadioContainer
          onChangeFormData={onChangeFormData}
        />
      );
    if (type === 'coach')
