  ...
  return(
    ...
    > 
      <div css={{ display: 'flex', alignItems: 'center' }}>
        ...
        <div css={{ backgroundColor: 'var(--green200)', color: 'var(--white100)', borderRadius: '4px', padding: '2px 10px' }}>{transferCoachPositionType(position)}</div>
      </div>
      <div css={{ margin: '16px 0 0 0', textAlign: 'right' }}>
        <span css={{ color: 'var(--blue200)'}}>{customerLessonCount}</span> 명의 수강생을 강습중이에요!
      </div>
    </div>
  )
};
