...
const ScheduleModalRegularLessonIndividualScheduleByDate = ({
  date,
  onChangeHandler,
  disabled,
}: Props) => {
  ...
  return (
    <div className="w-[calc(15%-8px)] [&_div]:p-0">
      <DatePicker
        locale={ko}
        showIcon
        icon={
        ...
        className="w-full py-2.5 pl-8 border border-gray-300 rounded-lg text-sm"
...
export default ScheduleModalRegularLessonIndividualScheduleByDate;