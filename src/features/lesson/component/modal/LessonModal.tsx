      ...
      <div className="text-sm mb-3">
        ...
        <div className="w-1/2 p-[10px_0_10px_10px] mt-3">
          ...
          {formData.name.isRequired && (
            <span className="text-red-500 text-xs">레슨권 이름이 입력되지 않았어요.</span>
          )}
        </div>
      </div>
      ...
      <div className="text-sm mb-3">
        ...
        <div className="w-1/2 p-[10px_0_10px_10px] mt-3">
          ...
          {formData.lessonCount.isRequired && (
            <span className="text-red-500 text-xs">총 레슨 횟수가 입력되지 않았어요.</span>
          )}
        </div>
      </div>
      ...
      <div className="text-sm mb-3">
        ...
        <div className="w-1/2 p-[10px_0_10px_10px] mt-3">
          ...
          {formData.price.isRequired && (
            <span className="text-red-500 text-xs">가격이 입력되지 않았어요.</span>
          )}
        </div>
      </div>
      ...
      <div className="text-sm mb-3">
        ...
        <div className="w-1/2 p-[10px_0_10px_10px] mt-3">
          ...
          {formData.time.isRequired && (
            <span className="text-red-500 text-xs">1회 레슨시간이 입력되지 않았어요.</span>
          )}
        </div>
      </div>
      ...
      <div className="text-sm mb-3">
        ...
        <div className="w-1/2 p-[10px_0_10px_10px] mt-3">
          ...
          {formData.timesAweek.isRequired && (
            <span className="text-red-500 text-xs">일주일 당 레슨횟수가 입력되지 않았어요.</span>
          )}
        </div>
      </div>
