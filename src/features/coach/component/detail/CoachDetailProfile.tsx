  ...
  return (
    ...
    >
      <div>
        ...
        <div
          className="text-center my-5 text-lg font-semibold"
        >
          {email}
        </div>
        <div className="flex">
      ...
      {errors.salary?.message ? (
        ...
        <div
          className="w-[65%] ml-[35%] px-1 text-xs break-words text-[var(--red100)]"
        >
