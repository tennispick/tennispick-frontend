...
import RadioSelectorGroup from 'src/widgets/RadioSelectorGroup';
...
import {
  ...
  vatRadioGroup,
} from '@/이전 파일들/features/setting/data/payment';
...
import { PaymentSettingSchema } from '@/이전 파일들/features/setting/util/zod';
import { useUpdatePaymentSettingMutation } from '@/이전 파일들/features/setting/mutation/settingMutation';
import { salaryRadioGroup } from '@/이전 파일들/features/setting/data/payment';
