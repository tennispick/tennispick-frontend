import {
  getPaymentSetting,
  getSettingList,
} from 'src/이전 파일들/apis/setting/setting.api';
import { SettingListApiPayload } from 'src/이전 파일들/apis/setting/setting.type';
import {
  URL_FETCH_SETTING_LIST,
  URL_PAYMENT_SETTING,
} from 'src/이전 파일들/apis/setting/setting.url';
