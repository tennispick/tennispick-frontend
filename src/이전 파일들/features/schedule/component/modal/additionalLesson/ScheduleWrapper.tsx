...
import StartTimeSelect from '@/이전 파일들/features/customer/component/detail/modal/scheduleChange/newSchedule/StartTime';
import EndTimeSelect from '@/이전 파일들/features/customer/component/detail/modal/scheduleChange/newSchedule/EndTime';
