...
import Pagination from 'src/이전 파일들/components/Pagination';
import { MouseEvent } from 'react';
import { useCustomerLessonHistoryQuery } from '@/이전 파일들/features/customer/query/CustomerQuery';
import { CustomerLessonHistoryData } from 'src/이전 파일들/apis/customer/customer.type';
