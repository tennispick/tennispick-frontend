...
import { ScheduleType } from '@/이전 파일들/features/schedule/type/schedule.type';
import { DuplicateCheckScheduleLessonData } from 'src/이전 파일들/apis/schedule/schedule.type';
