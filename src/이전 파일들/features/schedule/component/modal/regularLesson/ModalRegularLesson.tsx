...
import { useScheduleMutation } from '@/이전 파일들/features/schedule/mutation/scheduleMutation';
import { useCustomerLessonListQuery } from '@/이전 파일들/features/customer/query/CustomerQuery';
...
import { getTimeGap } from 'src/이전 파일들/utils/date';
import ScheduleModalRegularLessonIndividualSchedule from './individualSchedule/IndividualSchedule';
import { handleInputArrayValidationCheck } from 'src/이전 파일들/utils/validation';

import { individualCreateFormValidationSet } from '@/이전 파일들/features/schedule/util/inputFormValidationSet';
