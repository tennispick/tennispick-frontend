...
import { URL_SCHEDULE_LESSON_BY_DATE } from 'src/이전 파일들/apis/schedule/schedule.url';
import { CustomerLessonCancelApiPayload } from 'src/이전 파일들/apis/customer/customer.type';
