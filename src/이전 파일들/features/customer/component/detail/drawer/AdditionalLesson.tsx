import { CustomerAdditionalLessonListData } from '@/이전 파일들/features/customer/type/customer.type';
import DrawerInputContainer from './InputContainer';
import { DeleteWhiteIcon } from 'src/이전 파일들/assets/icons/index';
import { FormEventHandler } from 'react';
import { deleteCustomerAdditionalLesson } from 'src/이전 파일들/apis/customer/customer.api';
