...
import { NoResult, Select } from 'src/이전 파일들/components/index';
import { useCustomerMemoListQuery } from '@/이전 파일들/features/customer/query/CustomerQuery';
...
import { useCreateMemoMutate } from '@/이전 파일들/features/customer/mutate/memo';
