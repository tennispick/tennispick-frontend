...
import {
  ...
  URL_CUSTOMER_DETAIL,
  URL_CUSTOMER,
} from 'src/이전 파일들/apis/customer/customer.url';
import { createInitialData } from 'src/이전 파일들/types/response';
import { getCustomerAdditionalLessonList } from 'src/이전 파일들/apis/customer/customer.api';
...
// camelcaseKeys(snakeCaseObject, { deep: true });
